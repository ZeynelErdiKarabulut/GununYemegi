package com.zerdikarabulut.bugunkuyemegim.ui.tatli;
...
public class TatliFragment extends Fragment {
    ...
    Retrofit retrofit;
    private TatliViewModel tatliViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        tatliViewModel = ViewModelProviders.of(this).get(TatliViewModel.class);
        View root = inflater.inflate(R.layout.fragment_tatli, container, false);
        recyclerView = root.findViewById(R.id.rcy_Tatli);

        tatliViewModel.getText().observe(this, new Observer<String>() {
            @Override
